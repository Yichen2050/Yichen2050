...
Hello!  I'm Victor,An IT specialist and cybersecurity Professional with a focus on cross platform for your Information Technology, Cybersecurity services.  I'm always open to new opportunities and collaborations, so feel free to get in touch if you have any questions or would like to discuss a project!
...
## IT Skills...  
- **Information Technology Professional**:IT infrastructure,Azure cloud,Active Directory,Networking
...
- **Frameworks/Libraries**: React, NodeJS, Express,JQuery, Boostrap, MaterialUI.
- **Databases**: 🗄️ MySQL, 🗄️ PostgreSQL, MongoDB.
- **Testing**: Jest, Mocha, Chai, Storybook, Cypress.
- **Code Editors**: ✒️ Sublime Text, ✒️ Visual Studio Code (VSCode),Atom
...
<details>	
  ...
  <p align=center>
  <img height="180em" src="https://github-readme-streak-stats.herokuapp.com/?user=Yichen2050&theme=synthwave&hide_border=false" />
  </p>
	<hr>
</details>
<details>	
...
<details>	
  ...
  <br/>
	Although I enjoy exploring new technologies and finding creative ways to solve problems through red teaming, I also love 
	<ul><li>hiking ⛰,</li> 
	<li>photography📸,</li> 
	<li>scuba diving🤿,</li>
	<li>fitness💪,</li>
...
Yichen2050/Yichen2050 is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
